...
import 'package:playa2/main27.dart';
import 'package:playa2/main5(visitante).dart';

// ignore: camel_case_types
class veintiseis extends StatelessWidget {
  final Widget child;
  const veintiseis({Key key, this.child}) : super(key: key); //termina
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.fromLTRB(100, 15, 20, 5),
            child: Row(
              children: [
                Text(
                  'Registrar taxi',
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => veintisiete()),
                      );
                    },
                    child: Container(
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text(
                          'Se autorizara el ingreso de taxi de 8AM a 6PM',
