...
import 'package:playa2/main28.dart';
import 'package:playa2/main5(visitante).dart';

// ignore: camel_case_types
class veintisiete extends StatelessWidget {
  final Widget child;
  const veintisiete({Key key, this.child}) : super(key: key); //termina
