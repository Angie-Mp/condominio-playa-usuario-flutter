...
import 'package:playa2/main54.dart';
import 'package:playa2/main58(suge-anterio).dart';
import 'package:playa2/main59.dart';

// ignore: camel_case_types
class cincuentaytres extends StatelessWidget {
  final Widget child;
  const cincuentaytres({Key key, this.child}) : super(key: key); //termina
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => cincuentaycuatro()),
                      );
                    },
                    child: Container(
                      padding: EdgeInsets.fromLTRB(20, 0, 0, 0),
