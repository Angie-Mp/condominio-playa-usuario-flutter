...
import 'package:playa2/main18.dart';
import 'package:playa2/main5(visitante).dart';
import 'package:playa2/main7.dart';

// ignore: camel_case_types
class diecisiete extends StatelessWidget {
  final Widget child;
  const diecisiete({Key key, this.child}) : super(key: key); //termina
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        showDialog(
                                            context: context,
                                            builder: (context) =>
                                                //segundo alert dentro de otro alert
                                                AlertDialog(
                                                  title: Container(
                                                      child: Column(
                                                    children: [
