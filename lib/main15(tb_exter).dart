...
import 'package:playa2/main16.dart';
import 'package:playa2/main5(visitante).dart';
// ignore: camel_case_types
class quince extends StatelessWidget {
  final Widget child;
  const quince({Key key, this.child}) : super(key: key); //termina
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => dieciseis()),
                      );
                    },
                    child: Container(
