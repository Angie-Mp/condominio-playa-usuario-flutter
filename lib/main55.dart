...
import 'package:playa2/main56.dart';
import 'package:playa2/main58(suge-anterio).dart';
import 'package:playa2/main59.dart';

// ignore: camel_case_types
class cincuentaycinco extends StatelessWidget {
  final Widget child;
  const cincuentaycinco({Key key, this.child}) : super(key: key); //termina
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => cincuentayseis()),
                      );
                    },
                    child: Container(
                      padding: EdgeInsets.fromLTRB(20, 0, 0, 0),
