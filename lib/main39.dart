...
import 'package:playa2/main40.dart';

// ignore: camel_case_types
class treintaynueve extends StatelessWidget {
  final Widget child;
  const treintaynueve({Key key, this.child}) : super(key: key); //termina
