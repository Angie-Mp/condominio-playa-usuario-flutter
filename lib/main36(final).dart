...
import 'package:playa2/main37(vt_rgt_tenis).dart';
import 'package:playa2/main4(menu).dart';
import 'package:playa2/main5(visitante).dart';

// ignore: camel_case_types
class treintayseis extends StatelessWidget {
  final Widget child;
  const treintayseis({Key key, this.child}) : super(key: key); //termina
            ...
            child: RaisedButton.icon(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => treintaysiete()));
              },
              shape: RoundedRectangleBorder(
