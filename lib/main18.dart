...
import 'package:playa2/main19.dart';
import 'package:playa2/main5(visitante).dart';

// ignore: camel_case_types
class dieciocho extends StatelessWidget {
  final Widget child;
  const dieciocho({Key key, this.child}) : super(key: key); //termina
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => diecinueve()),
                      );
                    },
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
