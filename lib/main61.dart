...
import 'package:playa2/main62.dart';

// ignore: camel_case_types
class sesentayuno extends StatelessWidget {
  final Widget child;
  const sesentayuno({Key key, this.child}) : super(key: key); //termina
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => sesentaydos()),
              );
            },
            child: Container(
