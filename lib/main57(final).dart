...
class cincuentaysiete extends StatelessWidget {
  final Widget child;
  const cincuentaysiete({Key key, this.child}) : super(key: key); //termina
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Container(
            ...
            child: FlatButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => cincuentaydos()),
                );
              },
              child: Text(
          ...
          Container(
            padding: EdgeInsets.fromLTRB(60, 200, 60, 50),
