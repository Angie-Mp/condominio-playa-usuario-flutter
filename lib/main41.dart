...
import 'package:playa2/main42.dart';

// ignore: camel_case_types
class cuarentayuno extends StatelessWidget {
  final Widget child;
  const cuarentayuno({Key key, this.child}) : super(key: key); //termina
