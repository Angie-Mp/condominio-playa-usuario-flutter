...
import 'package:playa2/main23.dart';
import 'package:playa2/main5(visitante).dart';

// ignore: camel_case_types
class veintidos extends StatelessWidget {
  final Widget child;
  const veintidos({Key key, this.child}) : super(key: key); //termina
